...
import com.retouno.greengarden.modelos.Agua;
        ...
        */
public class ServiceRegisterItem1Activity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (!volumen.getText().toString().isEmpty() && !precio.getText().toString().isEmpty() && !mes.getText().toString().isEmpty()) {
                    ...
                    if (mesExiste) {
                        ...
                        Toast.makeText(ServiceRegisterItem1Activity.this, "El mes ya existe", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        if (datosGuardados) {
                            ...
                            Toast.makeText(ServiceRegisterItem1Activity.this, "Error al guardar el archivo",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                } else {
                    // Algunos campos están vacíos
                    Toast.makeText(ServiceRegisterItem1Activity.this, "Los campos no pueden estar vacíos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
