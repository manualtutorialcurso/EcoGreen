...
public class UserRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botonRegistro = findViewById(R.id.btnRecRegister);
        final EditText nombre = findViewById(R.id.inputRegName);
        final EditText apellidos = findViewById(R.id.inputRegLastName);
        final EditText correo = findViewById(R.id.inputRegMail);
        final EditText nickname = findViewById(R.id.inputRegNickName);
        final EditText password1 = findViewById(R.id.inputRegPassword);
        final EditText password2 = findViewById(R.id.inputRepRegPassword);
        CheckBox terminosCondiciones = findViewById(R.id.checkBoxTerminos);
        CheckBox tratamientoDatos = findViewById(R.id.checkBoxDatos);
                ...
                if (terminosCondiciones.isChecked() && tratamientoDatos.isChecked()) {
                    ...
                    if (!nombre.getText().toString().isEmpty() &&
                        ...
                        if (password1.getText().toString().equals(password2.getText().toString())) {
                            ...
                            if (datosExisten(correo.getText().toString(), nickname.getText().toString(), nombre.getText().toString(), apellidos.getText().toString())) {
    ...
    private void guardarRegistro(Usuario nuevoUsuario) {
        ...
        try {
            ...
            String nuevoRegistro = nuevoUsuario.getNombre() + "," + nuevoUsuario.getApellidos() + "," + nuevoUsuario.getCorreo() + "," + nuevoUsuario.getNickname() + "," + nuevoUsuario.getPassword() + "\n";
