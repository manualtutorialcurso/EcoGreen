            ...
            public void onClick(View v) {
                ...
                if (!kilovatio.getText().toString().isEmpty() && !precio.getText().toString().isEmpty() && !mes.getText().toString().isEmpty()) {
                    ...
                    if (mesExiste) {
                        ...
                        Toast.makeText(ServiceRegisterItem2Activity.this, "El mes ya existe",
                        ...
                        if (datosGuardados) {
                            ...
                            Toast.makeText(ServiceRegisterItem2Activity.this, "Error al guardar el archivo",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                } else {
                    // Algunos campos están vacíos
                    Toast.makeText(ServiceRegisterItem2Activity.this, "Los campos no pueden estar vacíos",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
